...
angular.module('FamilySleep').controller('LogModalInstanceCtrl', function ($uibModalInstance, $scope, famMems, famID) {
    ...
    var prompts = [
        ...
        "<i>Recommended for two family members.</i> Look at family weekly sleep together, pick a day. Tell us what you learn from each other's sleep",
        "<i>Look at your sleep and mood for this week.</i> How is your mood with respect to your sleep?",
        "<i>Recommended fo one parent and one child.</i> Look at today's sleep and mood. Talk to each other about your sleep and mood.",
        "<i>Recommended child to participate.</i> What have you learned about your sleep?",
        "<i>Recommended child to participate.</i> What have you learned your family's sleep?",
        "<i>Recommended for one parent and one child.</i> Think about how you viewed your sleep and mood before using DreamCatcher. What have you learned about each other?",
        "<i>Recommended for one parent and one child.</i> What have you learned about each other since using DreamCatcher?"
    ];
